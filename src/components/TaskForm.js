...
//       title,
//       description,
//       deadline: moment(deadline).format('YYYY-MM-DDTHH:mm'), // Format the deadline using moment
//       priority,
//       tags,
//       reminder: reminder ? moment(reminder).format('YYYY-MM-DDTHH:mm') : '', // Format the reminder using moment
//     };
