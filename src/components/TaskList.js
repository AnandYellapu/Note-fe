...
const currentTasks = sortedTasks.slice(indexOfFirstTask, indexOfLastTask);
  ...
  <div className="modal-container">
    ...
    <TextField
      ...
      onChange={(e) => setEditingTask({ ...editingTask, title: e.target.value, description: editingTask.description, deadline: editingTask.deadline, priority: editingTask.priority, tags: editingTask.tags, reminder: editingTask.reminder })}
